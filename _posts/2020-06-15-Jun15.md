...
There's an initial period where everything sounds so easy, then you run into some snags and you realize that what felt obviously true is nothing more than a heuristic, etc etc the world is complex you're . The most recent place where I'm going through the first stage of this insight-delusion is "dealing with random feeling down stuff".
